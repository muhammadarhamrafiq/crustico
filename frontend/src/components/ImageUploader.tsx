...
const ImageUploader = ({name = 'image', value, onChange, previewUrl} : ImageUploaderProps) => {
    ...
    return (
        <div>
            <label htmlFor="file-upload" className="cursor-pointer">
                <div className="w-80 h-80 border-2 border-dashed border-gray-400 rounded-md flex items-center justify-center">
                    {
                        preview ? (
